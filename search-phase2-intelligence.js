(function(){
  ...
  const STOP=new Set(['the','a','an','is','are','me','mujhe','mujko','mko','chahiye','chaiye','please','for','of','in','on','at','par','pe','pr','ke','ka','ki','k','near','nearby','pass','pas','paas','hai','hain','ko','se','tak','and','or','ya','with','under','below','upto','up','less','than','within','above','over','more','greater','minimum','min','at','least','budget','me','mein','mai','m','में','पर','के','का','की','पास','को','से','तक','और','या','चाहिए','चाहिये']);
  ...
  function install(){
    ...
    window.ranked=function(data,q){
      ...
      const nq=String(q),scored=base.map(r=>{const c=conditionScore(r,nq);return {...r,__phase2Score:c.score,__phase2Conditions:c};});
